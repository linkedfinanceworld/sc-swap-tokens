...
enum RouterVersion {
  LFWSwapRouter = 'LFWSwapRouter'
}

describe('LFWSwapRouter', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.LFWSwapRouter]: fixture.router
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        const expectedOutputAmount = bigNumberify('1663609990329787588')
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.LFWSwapRouter]: 103122
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapTokensForExactTokens', () => {
        const token0Amount = expandTo18Decimals(5)
        const token1Amount = expandTo18Decimals(10)
        const expectedSwapAmount = bigNumberify('556780472595265139')
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.LFWSwapRouter]: 110033
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
